...
const resetAreaCloseButton = document.getElementById('close');
...
const pilotMechaPairs = [
  ...
  {id: 'belladonna',
   img1: 'index_data/textures/cards/front/pilot/Belladonna.png',
  ...
  {id: 'jiuChong',
   img1: 'index_data/textures/cards/front/pilot/Jiu Chong.png',
...
function initializeGame() {
  ...
  gameArea.style.gridTemplateColumns = `repeat(${numColumns}, 100px)`;
...
function checkForMatch() {
  ...
  if (value1 === value2) {
    ...
    setTimeout(() => {
      card1.classList.remove('notmatched');
      card2.classList.remove('notmatched');
...
resetAreaCloseButton.addEventListener('click', function(){
